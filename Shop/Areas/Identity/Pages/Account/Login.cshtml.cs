        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    List<ShoppingCart> listShoppingCart = await _db.ShoppingCart.Where(u => u.UserId == user.Id).ToListAsync();

                    HttpContext.Session.SetInt32(StaticDefault.ssShopingCartCount, listShoppingCart.Count);
